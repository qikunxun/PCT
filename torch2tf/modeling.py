...
class BertModel(object):
    ...
    def __init__(self,
        ...
        with tf.variable_scope(scope, default_name="bert"):
            ...
            if with_mlm:
                self.get_masked_lm_output(config, self.sequence_output, masked_lm_positions)
    ...
    def get_masked_lm_output(self, config, input_tensor, positions):
    ...
    def get_next_sentence_output(self, config, input_tensor):
