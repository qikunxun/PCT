...
k = 16
train_path = 'PCT/datasets/xnli/fewshot_new/train_fewshot_' + str(k) + '.txt'
valid_path = 'PCT/datasets/xnli/fewshot_new/valid_fewshot_' + str(k) + '.txt'
...
with strategy.scope():
    ...
    model.summary()
checkpoint = ModelCheckpoint(filepath='PCT/model.hdf5', monitor='val_accuracy', verbose=True, save_best_only=True, save_weights_only=True, mode='max')
